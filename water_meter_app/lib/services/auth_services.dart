...
class AuthServices {
 ...
 /* SIGN UP */
  void signUpUser({
    ...
    print('Call LINK: ${ApiConstant.baseUrl}/user/api/register');
      http.Response res = await http.post(
        Uri.parse('${ApiConstant.baseUrl}/user/api/register'),
        body: user.toJson(),
 ...
 void signInUser({
  ...
  try{
    ...
    print('Call LINK: ${ApiConstant.baseUrl}/user/api/login');
    final url = Uri.parse('${ApiConstant.baseUrl}/user/api/login');
