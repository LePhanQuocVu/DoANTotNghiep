...
class CharacteristicTile extends StatefulWidget {
  ...
  @override
  State<CharacteristicTile> createState() => _CharacteristicState();
}

class _CharacteristicState extends State<CharacteristicTile> {
  ...
  // Function to convert the SSID and Password to bytes for writing
 ...
 Future onReadPressed() async {
  ...
  Widget buildValue(BuildContext context) {
    ...
    return Text(data, style: const TextStyle(fontSize: 13, color: Color.fromARGB(255, 167, 1, 1)));
  }

    Widget buildDecodedValue(BuildContext context) {
    return Text(
      'Decoded Data: $_decodedValue',  // String converted
      ...
      title: ListTile(
        title: Column(
          ...
          children: <Widget>[
            ...
            buildUuid(context),
            buildValue(context),
            buildDecodedValue(context),
            buildInputFields(context),  // Display input fields for SSID and password
          ],
        ),
